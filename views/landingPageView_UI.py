...
"")
        ...
        self.blueCard = QWidget(self.widget)
...
"}")
        ...
        self.studentPlacementStatCardImage.setPixmap(QPixmap(u":/icons/land-graph.png"))
        ...
        self.studentPlacementStatCardButtons_2 = QWidget(self.studentPlacementStatCard)
        ...
        self.studentPlacementStatCardRButtons_2 = QWidget(self.studentPlacementStatCardButtons_2)
        ...
        self.studentPlacementStatCardNextButton_2.setPixmap(QPixmap(u":/icons/arrow.png"))
...
"")
        ...
        self.companyPlacementStatCardImage.setPixmap(QPixmap(u"../assets/card2.png"))
...
"")
        ...
        icon = QIcon()
        icon.addFile(u":/icons/databaseUpload.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.label.setPixmap(QPixmap(u":/icons/files1.png"))
