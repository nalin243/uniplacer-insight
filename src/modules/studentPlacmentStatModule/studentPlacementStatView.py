...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QSize(1920, 1118))
...
"background-image:url(\"../../../assets/studentStatbg.png\");\n"
"}")
        ...
        self.appLogo.setPixmap(QPixmap(u"../../../assets/applogo.png"))
        ...
        self.totalStudentsImage.setPixmap(QPixmap(u"../../../assets/graduating-student.png"))
        ...
        self.studentsEligibleImage.setPixmap(QPixmap(u"../../../assets/checked.png"))
        ...
        self.studentsAppliedImage.setPixmap(QPixmap(u"../../../assets/list.png"))
        ...
        self.totalCompaniesImage.setPixmap(QPixmap(u"../../../assets/job.png"))
        ...
        self.studentsNotAppliedImage.setPixmap(QPixmap(u"../../../assets/delete.png"))
        ...
        self.studentsPlacedImage.setPixmap(QPixmap(u"../../../assets/email.png"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.campusComboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"KTR", None))
        self.campusComboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"Ramapuram", None))
        self.campusComboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"Tiruchipalli", None))
        ...
        self.departmentComboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"Computer Applications", None))
        self.departmentComboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"Journalism and Mass Communication", None))
        self.departmentComboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"Computer Science", None))
        self.departmentComboBox.setItemText(3, QCoreApplication.translate("MainWindow", u"Applied Data Science", None))
        self.departmentComboBox.setItemText(4, QCoreApplication.translate("MainWindow", u"English", None))
        self.departmentComboBox.setItemText(5, QCoreApplication.translate("MainWindow", u"Mathematics and Statistics", None))
        self.departmentComboBox.setItemText(6, QCoreApplication.translate("MainWindow", u"Biotechnology", None))
        self.departmentComboBox.setItemText(7, QCoreApplication.translate("MainWindow", u"Commerce", None))
        self.departmentComboBox.setItemText(8, QCoreApplication.translate("MainWindow", u"Hotel and Catering Management", None))
        self.departmentComboBox.setItemText(9, QCoreApplication.translate("MainWindow", u"BioChemistry", None))
        self.departmentComboBox.setItemText(10, QCoreApplication.translate("MainWindow", u"Fashion Designing", None))
        self.departmentComboBox.setItemText(11, QCoreApplication.translate("MainWindow", u"Visual Communication", None))
        self.departmentComboBox.setItemText(12, QCoreApplication.translate("MainWindow", u"Psychology", None))

        self.departmentComboBox.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Department ", None))
        self.courseComboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"Bca", None))
        self.courseComboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"Mca", None))
        self.courseComboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"Bsc Biotech", None))
        self.courseComboBox.setItemText(3, QCoreApplication.translate("MainWindow", u"Msc", None))

        self.courseComboBox.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Course", None))
        self.genderComboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"Male", None))
        self.genderComboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"Female", None))
        self.genderComboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"Other", None))
